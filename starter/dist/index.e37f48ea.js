...
const loadSearchResults = async function(query) {
    try {
        ...
        console.error(`${err} in SEARCH LOAD`);
        throw err;
    }
};
const getSearchResultsPage = function(page = state.search.page) {
    state.search.page = page;
    const start = (0, _configJs.RES_PER_PAGE) * (page - 1);
...
const KEY = "4373731a-6810-45ab-b6e1-90498bca2f16";
...
const getJSON = async function(url) {
    try {
        ...
        if (!res.ok) throw new Error(`${data.message} (${res.status})YOOOOOOO`);
        return data;
    } catch (error) {
        throw error;
    }
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `Recipe was not found. Please try another one!`;
    _message = ``;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","./View.js":"5cUXS"}],"loVOp":[function(require,module,exports) {
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _message = "Recipe was succesfully aploaded";
